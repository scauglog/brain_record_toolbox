...
my_bsc = bsc.brain_state_calculate(32, 1, 'koho_RL', ext_img, save, show)
my_bsc2 = bsc.brain_state_calculate(32, 1, 'koho', ext_img, save, show)
...
for i in range(5, len(files0423)):
    ...
    l_res, l_obs = my_bsc.convert_cpp_file(dir_name, 't_0423', files0423[i-1:i], False, cut_after_cue=False, init_in_walk=True)
